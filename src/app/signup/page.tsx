      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ backgroundColor: '#0D6B6E' }}>
        <div className="absolute inset-0 opacity-10 flex items-center justify-center">
          <svg width="300" height="300" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M60 5L68 25L90 25L72 38L78 58L60 46L42 58L48 38L30 25L52 25L60 5Z" fill="none" stroke="#C8991A" strokeWidth="1"/>
            <circle cx="60" cy="30" r="3" fill="#C8991A" opacity="0.5"/>
          </svg>
        </div>
